    ...
    export default {
        ...
        data() {
            return {
                ...
                helpMessages: ["B:True binary tree construction, comma separated. For example 1,,2,,3 correspond {1: [null, 2: [null, 3]]}",
                    "I: (Enter) input sequences are inserted in sequence, separated by commas. The values have upper and lower limits.",
                    "S: Enter a single value to search",
                    "P: Generate a true binary tree hierarchical traversal sequence (copy it and rebuild it at any time))"]
            };
        },
        components: {
